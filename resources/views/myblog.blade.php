			...
			<div class="row">
				<div class="col-md-8">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="post">
								<a class="post-img" href="#"><img src="{{ $newpost->picture}}" alt=""></a>
								<div class="post-body">
									<div class="post-category">
										<a href="#">{{ $newpost->category->name}}</a>
									</div>
									<h3 class="post-title"><a href="#">{{$newpost->title}}</a></h3>
									<ul class="post-meta">
										<li><a href="#">{{$newpost->users->name}}</a></li>
